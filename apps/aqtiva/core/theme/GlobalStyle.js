...
export const GlobalStyles = createGlobalStyle`
  ...
  .row-green {
    background-color: rgba(122, 210, 118, 0.6);
  }

  .row-red {
    background-color: rgba(255, 0, 21, 0.49);
  }
  ...
  .fullview-modal .ant-modal-content {
    height: 100vh;
    width: 100vw;
    margin: 0;
    top: 0;
  ...
  .fullview-modal .ant-modal-content .ant-modal-body {
