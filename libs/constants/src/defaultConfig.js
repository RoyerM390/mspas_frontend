...
export const defaultTheme = {
  theme: {
    ...
    palette: {
      ...
      primary: {
        main: '#0A8FDC', //process.env.NX_PRIMARY_COLOR,
        contrastText: '#fff',
      },
      secondary: {
        main: '#F04F47' //process.env.NX_SECONDARY_COLOR,
      },
      success: {
        main: '#52c41a', //'#11C15B',
        light: '#D9F5E5',
...
const defaultConfig = {
  ...
  themeMode: 'light', //process.env.NX_THEME_MODE,
  footerType: FooterType.FLUID,
  navStyle: 'default', //process.env.NX_NAV_STYLE,
  layoutType: 'full-width', //process.env.NX_LAYOUT_TYPE,
  footer: true,
  rtlLocale: ['ar'],
};
