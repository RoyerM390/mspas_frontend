...
export const SET_TOTAL_INGRESOS = 'set_total_ingresos';
export const SET_TOTAL_EGRESOS = 'set_total_egresos';
export const CLEAR_TOTAL_INGRESOS = 'clear_total_ingresos';
export const CLER_TOTAL_EGRESOS = 'clear_total_egresos';

// PRESTAMOS

export const SET_PRESTAMO = 'set_prestamo';
export const CLEAR_PRESTAMO = 'clear_prestamo';
