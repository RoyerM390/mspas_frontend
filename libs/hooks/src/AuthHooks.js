// ForJWT Auth
import { getUserFromJwtAuth } from '@aqtiva/helpers';
import {
  useJWTAuth,
  useJWTAuthActions,
} from '@aqtiva/services/auth/JWTAuthProvider';
...
//For Firebase Auth
//
// import { useFirebase, useFirebaseActions } from "@aqtiva/services/auth/FirebaseAuthProvider";
// import {getUserFromFirebase} from "@aqtiva/helpers";
//
//
// export const useAuthUser = () => {
...
/*
// For AWS Auth
import {getUserFromAWS} from '@aqtiva/helpers';
import {
  useAwsCognito,
  useAwsCognitoActions,
} from '@aqtiva/services/auth/AWSAuthProvider';
